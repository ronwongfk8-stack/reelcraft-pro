...
import { Film, Sparkles, Wand2, PlayCircle, LifeBuoy } from 'lucide-react';
  ...
  return (
    <header className="bg-slate-900 border-b border-slate-800 px-4 lg:px-8 py-3.5 flex flex-col md:flex-row md:items-center justify-between gap-4 sticky top-0 z-40 shadow-lg">
      ...
      <div className="flex flex-wrap items-center gap-2 md:gap-3">
        ...
        {/* Help / Contact Trigger */}
        {onOpenHelp && (
          <button
            onClick={() => onOpenHelp('help')}
            title="Help & Support"
            className="flex items-center justify-center bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-amber-400 p-2 rounded-lg border border-slate-700 transition-colors"
          >
